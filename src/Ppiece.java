...
/**
 * The "Ppiece" class
 * Purpose: To make and keep track of a Ppiece
...
public class Ppiece extends Piece
{
	 ...
	 */
	public Ppiece(Image image, int x, int y, int orientation) {
		super(image, x, y, orientation);
		type = P_PIECE; 
		positions = new Point[][]{{new Point (0,1), new Point (0,2), new Point (1,2), new Point(1,1)}, 
				{new Point (1,0), new Point (2,0), new Point (2,-1), new Point(1,-1)},
				{new Point (0,-1), new Point (0,-2), new Point (-1,-2), new Point(-1,-1)},
				{new Point (-1,0), new Point (-2,0), new Point (-2,1), new Point(-1,1)},
				{new Point (0,-1), new Point (0,-2), new Point (1,-2), new Point(1,-1)},
				{new Point (1,0), new Point (2,0), new Point (2,1), new Point(1,1)},
				{new Point (0,1), new Point (0,2), new Point (-1,2), new Point(-1,1)}, 
